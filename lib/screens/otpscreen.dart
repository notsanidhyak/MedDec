...
import 'package:health/screens/userInfoScreen.dart';
                        ...
                        child: Form(
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              // ),
                              const SizedBox(height: 10),
                              Padding(padding: const EdgeInsets.only(left:184),
        ...
        onSuccess: () {
            ap.checkExistingUser().then((value) async {
              if(value==true){
                ...
                {
                  Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context)=> const UserInfoScreen()), (route) => false);
                }
            });
        }
    );
